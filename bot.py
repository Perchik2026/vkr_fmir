...
def create_req_keyboard():
    ...
    keyboard.add_line()
    keyboard.add_button("Ссылки", color=VkKeyboardColor.POSITIVE)
    keyboard.add_button("Список литературы", color=VkKeyboardColor.POSITIVE)
    keyboard.add_line()
    ...
    keyboard.add_line()
    keyboard.add_button("Птичий язык", color=VkKeyboardColor.POSITIVE)
    keyboard.add_button("Слова-паразиты", color=VkKeyboardColor.POSITIVE)
    keyboard.add_line()
    keyboard.add_button("Научный стиль", color=VkKeyboardColor.NEGATIVE)
    keyboard.add_button("Запрещенные сети", color=VkKeyboardColor.NEGATIVE)
    keyboard.add_line()
