...
def create_req_keyboard():
    ...
    keyboard.add_button("Источники", color=VkKeyboardColor.POSITIVE)
    keyboard.add_line()
    ...
    keyboard.add_line()
    keyboard.add_button("Цитирование", color=VkKeyboardColor.POSITIVE)
    keyboard.add_button("Публикации ППС", color=VkKeyboardColor.POSITIVE)
    keyboard.add_line()
