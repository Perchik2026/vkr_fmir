...
def create_req_keyboard():
    ...
    keyboard.add_button("Список литературы", color=VkKeyboardColor.SECONDARY)
    keyboard.add_line()
    ...
    keyboard.add_line()
    keyboard.add_button("Птичий язык", color=VkKeyboardColor.SECONDARY)
    keyboard.add_button("Слова-паразиты", color=VkKeyboardColor.SECONDARY)
    keyboard.add_line()
    ...
    keyboard.add_line()
    keyboard.add_button("Форматирование текста", color=VkKeyboardColor.SECONDARY)
    keyboard.add_button("Англицизмы", color=VkKeyboardColor.SECONDARY)
    keyboard.add_line()
    keyboard.add_button("Сроки проверки работ", color=VkKeyboardColor.POSITIVE)
    keyboard.add_button("Обозначения и сокращения", color=VkKeyboardColor.POSITIVE)
    keyboard.add_line()
    keyboard.add_button("Материалы по оформлению", color=VkKeyboardColor.SECONDARY)
    keyboard.add_line()
    keyboard.add_button("🔙 Главное меню", color=VkKeyboardColor.NEGATIVE)
    return keyboard
